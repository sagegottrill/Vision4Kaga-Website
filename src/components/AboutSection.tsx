      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-4">Overview of Kaga Local Government</h2>
            <div className="w-24 h-1 bg-green-600 mx-auto rounded-full"></div>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border-l-4 border-blue-900">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Location & Administration</h3>
              <p className="text-gray-600 leading-relaxed">
                Situated in the northern region of Borno State, Kaga Local Government Area serves as a vital economic and historical bridge between Borno and Yobe States. Its administrative headquarters, Benisheikh, is strategically positioned along the major Maiduguri-Damaturu highway.
              </p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border-l-4 border-green-600">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Demographics & Heritage</h3>
              <p className="text-gray-600 leading-relaxed">
                Home to over 180,000 residents, Kaga is a vibrant community predominantly inhabited by the Kanuri ethnic group. The Local Government comprises fifteen (15) wards, each rich in cultural heritage and communal spirit.
              </p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border-l-4 border-yellow-500">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Geography & Economy</h3>
              <p className="text-gray-600 leading-relaxed">
                Spanning approximately 2,700 square kilometers, Kaga is an agricultural powerhouse. The economy is anchored in farming, animal husbandry, and commerce, serving as a key supplier of grains, vegetables, and livestock to markets across Borno and neighboring states.
              </p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border-l-4 border-purple-600">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Key Communities</h3>
              <p className="text-gray-600 leading-relaxed">
                Our diverse and resilient communities include Benisheikh, Ngamdu, Mainok, Margube, Galangi, Wajiro, and many others, all united in their pursuit of progress and development.
              </p>
            </div>
          </div>
        </div>
