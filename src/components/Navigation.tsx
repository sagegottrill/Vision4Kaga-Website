      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-4">
            <button onClick={() => scrollToSection('donate')} className="hidden md:block bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 hover:scale-105 transition transform">Support Campaign</button>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-4 py-4 space-y-3">
            <button onClick={() => scrollToSection('council')} className="block w-full text-left py-2 text-gray-700">The Council</button>
